                                        ...
                                        @else
                                            @foreach ($orders as $order)
                                                <tr>
                                                    ...
                                                    {{-- <td>{{ \Carbon\Carbon::parse($order->transaction_time)->addHours(2)->format('H:i:s') }}</td> <!-- Jam Kedatangan (+2 Jam) --> --}}
                                                    <td>{{ \Carbon\Carbon::parse($order->transaction_time)->format('H:i:s') }}</td> <!-- Jam Kedatangan (+2 Jam) -->
                                                    <td>
